...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('ol'), require('ol/proj'), require('echarts')) :
    typeof define === 'function' && define.amd ? define(['ol', 'ol/proj', 'echarts'], factory) :
    (global = global || self, global.EChartsLayer = factory(global.ol, global.ol.proj, global.echarts));
}(this, function (ol, proj, echarts) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var _options = {
        ...
        insertFirst: false,
        stopEvent: false,
        polyfillEvents: semver(ol.VERSION, '6.1.1') <= 0,
    };
